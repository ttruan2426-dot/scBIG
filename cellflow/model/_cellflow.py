...
class CellFlow:
    ...
    def prepare_model(
        ...
        # CellFlow_VC: optional OTFM velocity field extensions
        ...
        otfm_vc_kwargs: dict[str, Any] = {}
        if self._solver_class == _otfm.OTFlowMatching:
            otfm_vc_kwargs = {
                "use_pathway_source_gate": use_pathway_source_gate,
                "pathway_source_gate_hidden": pathway_source_gate_hidden,
                "use_pathway_token_xattn": use_pathway_token_xattn,
                "pathway_xattn_dim": pathway_xattn_dim,
                "pathway_xattn_heads": pathway_xattn_heads,
                "vc_pathway_learned": vc_pathway_learned,
                "use_vc_de_head": use_vc_de_head,
                "vc_de_topk": vc_de_topk,
            }
